...
import type { HandoffStatus } from '@/data/seed';
import { ArrowRight, Package, CheckCircle2, Clock, Zap, XCircle, Play } from 'lucide-react';
                ...
                >
                  ...
                  <div className="flex gap-4 mt-3 pt-3 border-t border-zinc-800/50">
                    ...
                    <span className="text-[10px] text-zinc-600 ml-auto">
                      ...
                      Updated {getTimeSince(h.updatedAt)}
                    </span>
                  </div>
                </Link>
              );
