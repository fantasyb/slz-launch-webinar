    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <div className="flex gap-2 w-full sm:w-auto">
          <div className="flex items-center gap-1 rounded-lg border border-zinc-800 px-1 overflow-x-auto">
            {CATEGORIES.map(cat => (
              <button
                key={cat}
                onClick={() => setCategory(cat)}
                className={`px-2 py-1.5 rounded text-[10px] font-medium transition-colors whitespace-nowrap ${
                  category === cat
